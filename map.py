...
出武器对准了你。
""","Please input 'shoot!','dodge1'or'tell a joke'")
...
""","choose '0132','0117','0124','0147'" )
the_birdge = Room("The Bridge",
"""
盒子咔哒一声打开了，密封破裂，毒气逸出。
...
the_birdge.add_paths({
    'throw the bomb': generic_death,
    'slowly place the bomb': escape_pod
})
wrong_one = Room("wrong","你输入错误一次，请重新输入","'0135','0134' or '0133'")
wrong_two = Room("wrong","你输入错误一次，请重新输入","'0132' or '0139'")
